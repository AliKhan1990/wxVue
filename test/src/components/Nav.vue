<template>
  ...
  <nav v-if="modelleft" class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav hidden-float">
        ...
        <li class="nav-item hidden-float">
          <a class="nav-link icon md-search" data-toggle="collapse" href="#example-navbar-default-search"
             role="button">
            <span class="sr-only">Toggle Search</span>
          </a>
        </li>
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
                <i class="icon md-card" aria-hidden="true"></i> Billing
              </a>
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem">
        ...
        <ul class="nav navbar-toolbar navbar-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="javascript:void(0)" role="menuitem">One more separated link</a>
            </div>
          </li>
        </ul>
      </div>
        ...
        <form role="search">
          <div class="form-group">
            <div class="input-search">
              ...
              <button type="button" class="input-search-close icon md-close" data-target="#example-navbar-default-search"
  ...
  <nav v-else class=" navbar navbar-default navbar-fixed-top  navbar-mega  "
  role="navigation">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
      ...
      <a class="nav-link waves-effect waves-light waves-round" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="fade" role="button">Mega <i class="icon md-chevron-down" aria-hidden="true"></i></a>
      <div class="dropdown-menu" role="menu">
      ...
      <a href="advanced/animation.html" class=" waves-effect waves-light waves-round">Animation</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/buttons.html" class=" waves-effect waves-light waves-round">Buttons</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/colors.html" class=" waves-effect waves-light waves-round">Colors</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/dropdowns.html" class=" waves-effect waves-light waves-round">Dropdowns</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/icons.html" class=" waves-effect waves-light waves-round">Icons</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="advanced/lightbox.html" class=" waves-effect waves-light waves-round">Lightbox</a>
      </li>
      </ul>
      </li>
      <li class="mega-menu m-0">
      <ul class="list-icons">
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/modals.html" class=" waves-effect waves-light waves-round">Modals</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/panel-structure.html" class=" waves-effect waves-light waves-round">Panels</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="structure/overlay.html" class=" waves-effect waves-light waves-round">Overlay</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/tooltip-popover.html " class=" waves-effect waves-light waves-round">Tooltips</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="advanced/scrollable.html" class=" waves-effect waves-light waves-round">Scrollable</a>
      </li>
      <li><i class="md-chevron-right" aria-hidden="true"></i>
      <a href="uikit/typography.html" class=" waves-effect waves-light waves-round">Typography</a>
      </li>
      </ul>
      </li>
      </ul>
      ...
      <ul class="blocks-3">
      <li>
      <a class="thumbnail m-0 waves-effect waves-light waves-round" href="javascript:void(0)">
      <img class="w-full" src="/remark/global/photos/placeholder.png" alt="...">
      </a>
      </li>
      <li>
      <a class="thumbnail m-0 waves-effect waves-light waves-round" href="javascript:void(0)">
      ...
      <a class="panel-title waves-effect waves-light waves-round" data-toggle="collapse" href="#siteMegaCollapseOne" data-parent="#siteMegaAccordion" aria-expanded="false" aria-controls="siteMegaCollapseOne">
      ...
      <a class="panel-title collapsed waves-effect waves-light waves-round" data-toggle="collapse" href="#siteMegaCollapseTwo" data-parent="#siteMegaAccordion" aria-expanded="false" aria-controls="siteMegaCollapseTwo">
      ...
      <a class="panel-title collapsed waves-effect waves-light waves-round" data-toggle="collapse" href="#siteMegaCollapseThree" data-parent="#siteMegaAccordion" aria-expanded="false" aria-controls="siteMegaCollapseThree">
      ...
      <ul v-if="isLogin()" class="nav navbar-toolbar navbar-right navbar-toolbar-right">
      <li v-if="language" class="nav-item dropdown">
      ...
      <div class="dropdown-menu" role="menu">
      <a class="dropdown-item waves-effect waves-light waves-round" href="javascript:void(0)" role="menuitem"><i class="icon md-account" aria-hidden="true"></i> Profile</a>
      <a class="dropdown-item waves-effect waves-light waves-round" href="javascript:void(0)" role="menuitem"><i class="icon md-card" aria-hidden="true"></i> Billing</a>
      <a class="dropdown-item waves-effect waves-light waves-round" href="javascript:void(0)" role="menuitem"><i class="icon md-settings" aria-hidden="true"></i> Settings</a>
      <div class="dropdown-divider"></div>
      ...
      <li v-if="news" class="nav-item dropdown">
      ...
      <li v-if="message" class="nav-item dropdown">
      ...
      <div class="media-left p-r-10">
      <span class="avatar avatar-sm avatar-off">
      <img src="/remark/global/portraits/3.jpg" alt="...">
      <i></i>
      </span>
      </div>
      <div class="media-body">
      ...
      <li v-if="push"  class="nav-item" id="toggleChat">
      <a class="nav-link waves-effect waves-light waves-round" data-toggle="site-sidebar" href="javascript:void(0)" title="Chat" data-url="site-sidebar.tpl">
      ...
      <!-- End Navbar Toolbar Right -->
        <div class="navbar-brand navbar-brand-center">
          <a href="#">
          <!--<img class="navbar-brand-logo" src="/logo.png" title="Remark">-->
            <h4 style="height: 30px; padding: 0; margin: 0 auto;">市长工作台</h4>
          </a>
        </div>
    </div>
    <!-- End Navbar Collapse -->
...
export default {
  name: 'ihnav',
  props: ['user', 'language', 'message', 'news', 'push'],
  data: function() {
    return {
      ...
      isLogin: function() {
          console.log(this);
        console.log(this.$store.userStore.state.isLogin);
        return this.$store.userStore.state.isLogin;
      },
    };
  },
};
